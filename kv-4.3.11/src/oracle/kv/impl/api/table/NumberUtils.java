...
public class NumberUtils {
     ...
     */
    static byte[] serialize(BigDecimal value) {
    ...
    private static Object createNumericObject(ReadBuffer in,
        ...
        if ((expo >= 0 && expo < LONG_MAX_DIGITS_NUM) &&
            ...
            try {
                long lval = Long.parseLong(digits);
     ...
     * byte to end of manitissa to make sure the bytes < nextUp() and there is
     * no legal value such that bytes < cantHappen < nextUp().
     *
