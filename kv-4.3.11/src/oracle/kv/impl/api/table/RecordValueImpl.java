...
public class RecordValueImpl extends ComplexValueImpl implements RecordValue {
    ...
    public RecordValue putJsonNull(int pos) {
        ...
        if (!getDefinition().getFieldDef(pos).isJson()) {
            String fname = getFieldName(pos);
            throw new IllegalArgumentException(
    ...
    FieldValueImpl findFieldValue(
        ...
        FieldValueImpl fv = get(fieldPath.next());
