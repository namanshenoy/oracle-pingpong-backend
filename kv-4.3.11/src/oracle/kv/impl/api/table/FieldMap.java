 ...
 * and re-defined the writeObject and readObject methods to always write and 
...
f     */
    ...
    public FieldMap findContainingMap(TablePath tablePath) {
        ...
        String currentStep = steps.get(0);
        ...
        while (stepIndex < steps.size() - 1) {
            ...
            if (currentStep == TableImpl.BRACKETS) {
                // def must be a map or array type
                if (def.isMap()) {
                    ...
                    throw new IllegalArgumentException(
                        ...
                        " does not have an array or map as input");
                }
            } else {
