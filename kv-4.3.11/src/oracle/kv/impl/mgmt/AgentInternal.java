...
public abstract class AgentInternal implements MgmtAgent {
    ...
    private class AdminStatusReceiverImpl
        ...
        @Override
        public void updatePlanStatus(PlanStateChange planState)
            throws RemoteException {

            AgentInternal.this.updatePlanStatus(planState);
        }
    }
    ...
    public abstract void updatePlanStatus(PlanStateChange planState);
