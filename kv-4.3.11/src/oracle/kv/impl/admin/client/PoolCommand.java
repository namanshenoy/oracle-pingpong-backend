...
class PoolCommand extends CommandWithSubs {
    ...
    static class ClonePool extends SubCommand {
        ...
        @Override
        protected String getCommandSyntax() {
            return "pool clone -name <name> -from <source pool name> [-json]";
        }
    ...
    static class LeavePool extends SubCommand {
        ...
        @Override
        protected String getCommandSyntax() {
            return "pool leave -name <name> [-sn <snX>]* [-json]";
        }
