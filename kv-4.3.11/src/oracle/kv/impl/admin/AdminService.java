...
public class AdminService implements ConfigurableService {
    ...
    private MgmtAgentPlanStateChangeTracker planListener = null;
    ...
    public static final String HEAP_DUMP_PATH_ARG = "-XX:HeapDumpPath=";
    ...
    void updateAdminStatus(Admin a, ServiceStatus newStatus) {
         ...
         * configured mode.
         */
        if (a != null && planListener == null) {
            planListener = new MgmtAgentPlanStateChangeTracker();
            a.getMonitor().trackPlanStateChange(planListener);
        }
    ...
    private class MgmtAgentPlanStateChangeTracker
        ...
        public void newInfo(ResourceId resourceId, PlanStateChange planState) {
            try {
                statusReceiver.updatePlanStatus(planState);
            } catch (RemoteException re) {
