...
public class BootstrapParams {
    ...
    public BootstrapParams(ParameterMap map, ParameterMap storageDirMap) {
        this.map = map;
    ...
    /**
     * Returns the storage directory paths in the specified map.
     * Important: storage directory paths are the names of the name/value
     * pairs in the map.  Values are the size, if specified.
     */
