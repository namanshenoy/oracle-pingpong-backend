...
public class StorageNodeParams implements ParamsWithMap, Serializable {
    ...
    /**
     * This contains the explicit storage directory entries. This map must have
     * the name BOOTSTRAP_MOUNT_POINTS.
     */
    ...
    public StorageNodeParams(ParameterMap map, ParameterMap storageDirMap) {
        this.map = map;
    ...
    public void setInstallationInfo(ParameterMap bootMap,
        ...
        if (bootMap != null) {
            ...
            BootstrapParams bp = new BootstrapParams(bootMap, storageDirMap);
