...
public class SecurityMetadataPlan extends MetadataPlan<SecurityMetadata> {
    ...
    public static AbstractPlan createDropUserPlan(AtomicInteger idGen,
                                                  String planName,
                                                  Planner planner,
                                                  String userName,
                                                  boolean cascade) {
        ...
        if (Utils.storeHasVersion(planner.getAdmin(),
            ...
            return createDropUserPlanV2(idGen, planName, planner, userName,
                                        cascade);
    ...
    private static RemoveUserPlanV2 createDropUserPlanV2(AtomicInteger idGen,
                                                         String planName,
                                                         Planner planner,
                                                         String userName,
                                                         boolean cascade) {
        ...
        final RemoveUserPlanV2 plan = new RemoveUserPlanV2(
            idGen, subPlanName, planner, userName, cascade);
        addNewMDChangeTasks(planner.getAdmin(), plan);
        return plan;
    }
