    ...
    private class PingTask implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                snLogger.warning("CollectorService: PingCollectorAgent error:"
                    + e.toString());
            } finally {
        ...
        private Ping doPing() throws KVStoreException {
            ...
            Ping ping = new Ping(helperHostPorts, true, true, ps,
                                 loginManager);
            ping.pingTopology();
            recorder.record(CollectorRecorder.MetricType.PING, os.toString());
            return ping;
        }
