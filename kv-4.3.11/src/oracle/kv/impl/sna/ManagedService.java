...
public abstract class ManagedService {
    ...
    private static final String JDK9_VERSION = "1.9";
    private static final String JDK9_EA_VERSION = "9-ea";
    ...
    String getGCLoggingArgs(final Parameter gcLogFiles,
        ...
        if (javaVersion.startsWith(JDK9_VERSION) ||
            javaVersion.equals(JDK9_EA_VERSION)) {
