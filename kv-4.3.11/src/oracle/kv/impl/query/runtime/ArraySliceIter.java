...
public class ArraySliceIter extends PlanIter {
    ...
    static private class ArraySliceState extends PlanIterState {
        ...
        ArrayValueImpl theHelperArray;

        int theElemPos;

        ArraySliceState(ArraySliceIter iter) {
            init(iter);
            theHelperArray = FieldDefImpl.arrayAnyDef.createArray();
        }
        ...
        while (true) {
            ...
            if (state.theCtxItem == null) {
                ...
                if (val.isArray()) {
                    ...
                    state.theHelperArray.clear();
                    state.theHelperArray.addInternal(val);
                    state.theCtxItem = state.theHelperArray;
